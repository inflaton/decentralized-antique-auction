...
contract AntiqueMarketplace is AnyNFTMarket {
    ...
    /**
     * @dev Delete a antique from the marketplace. Only the antique's owner or the
     * marketplace's owner is authorised for this operation.
     *
     * Returns a boolean value indicating whether the operation succeeded.
     *
    ...
    /**
     * @dev Emitted when a new antique is added to the marketplace.
    ...
    /**
     * @dev Emitted when a antique is deleted from the marketplace.
     */
